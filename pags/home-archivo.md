...
<div class='fondo-blanco'>
  ...
  <div class='fondo-blanco'>
    <div class='wrap'>
      <div class='seccion'>
        <a href="#"><h5><i class="icn icn-noticias icn-md"></i> Noticias</h5></a>
      </div>
      <div class='fila'> <!-- Noticia destacada -->
        ...
        <div class='col-md-6 margen-superior'> 
          ...
          <a href='/pags/portada_noticias_archivo/index.html'><h2 class='rojo-claro fina'>Un retrato de la vida en los cerros</h2></a>
          ...
          <div class='margen-ver-mas'>
            <a href='/pags/portada_noticias_archivo/index.html'><i class='icn icn-mas icono-mas icn-lg rojo-claro'></i></a>
          </div>  
        </div>
  ...
  <div class='wrap'> <!--  Inicio Álbumes destacados -->    
    <div class='seccion'>
       <a href='#'><h5><i class="icn icn-estrella-l icn-md"></i> Álbumes destacados</h5></a>
    </div>
    <div class='fila'>
      <div class='col-lg-3 col-md-3 col-sm-6 col-xs-12'>      
      ...
      <div class='fondo-blanco'><!-- inicio publicaciones recientes -->
        <div class='wrap'>
          <div class='seccion'>
             <a href='#'><h5><i class="icn icn-etiqueta icn-md"></i>Publicaciones recientes</h5></a>
          </div>
          <div class='fila'> <!-- Noticia destacada -->
            <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
      ...
      <div class='wrap'>
        <div class='seccion'>
          <a href='#'><h5><i class="icn icn-biblioteca icn-md"></i> Catálogos en línea</h5></a>
        </div>
        <div class='fila'>            
          <div class='col-lg-3 col-md-3 col-sm-6 col-xs-12'>
