...
<div class='fondo-blanco'>
    ...
    <div data-ride="carousel" class="carousel slide" id="carousel-example-generic"> 
      ...
      <div class="carousel-inner"> 
        ...
        <div class="item imagen-carousel"> <!-- 4to slide -->
          <img class='altura-maxima' alt="Fourth slide" src="{{ site.baseurl }}/img/img-archivo/nuevo-album-flickr3.jpg" title="Nuevo álbum en Flickr"> 
          <div class='pie-de-foto'> 
  ...
  <div class='wrap'>
    ...
    <div class='fondo-blanco'>
      <div class='wrap'>
        <div class='seccion'>
          <h3><i class="icn icn-enlace-lig"></i>Archivo en el mundo</h3>
        </div>
